      ...
      <div class="cart-body">
        ...
        <table class="product-list--cart">
          ...
          <tr class="product">
            ...
            <!-- price -->
            <td class="price">199000</td>

            <!-- amount -->
            <td>
              <div class="flex amount">
                <button class="amount-btn pointer minus">-</button>
                <input type="number" min="1" value="1" onChange="updateMoney(0)"/>
          ...
          <tr class="product">
            ...
            <td>
              <div class="flex amount">
                <button class="amount-btn pointer minus">-</button>
                <input type="number" min="1" value="1" onChange="updateMoney(1)"/>
                <button class="amount-btn pointer plus">+</button>
              </div>
            </td>
          ...
          <tr class="product">
            ...
            <td>
              <div class="flex amount">
                <button class="amount-btn pointer minus">-</button>
                <input type="number" min="1" value="1" onChange="updateMoney(2)"/>
                <button class="amount-btn pointer plus">+</button>
              </div>
            </td>

<!-- start of Modal of Add new elements-->
        ...
        <div class="modal fade modal-lg" id="add-new" tabindex="-1" aria-labelledby="#add-product" aria-hidden="true">
                        ...
                        <form action="" class="add-new-product">
                            <div class="row g-2">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" id="product-price" class="form-control" min="0" step="1" value="0">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="number" id="product-quantity" class="form-control" min="0" step="1" value="0">
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    ...
                                    <select id="product-category" class="form-select">
                                        <option value="" disabled selected hidden>Chọn loại giày</option>
